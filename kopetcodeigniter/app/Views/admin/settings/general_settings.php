                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row" style="max-width: 400px; margin-bottom: 15px;">
                                            <div class="col-sm-12 col-md-6">
                                                ...
                                                <input type="number" name="logo_width" class="form-control" value="<?= getLogoSize('width'); ?>" min="10" max="300" required>
                                            </div>
                                            <div class="col-sm-12 col-md-6">
                                                <label class="control-label"><?= trans("height"); ?>&nbsp;(px)</label>
                                                <input type="number" name="logo_height" class="form-control" value="<?= getLogoSize('height'); ?>" min="10" max="300" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane<?= $activeTab == '4' ? ' active' : ''; ?>" id="tab_4">
                        ...
                        foreach ($socialArray as $item):?>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="<?= $item['name']; ?>" placeholder="<?= trans("enter_url"); ?>" value="<?= esc($item['value']); ?>" maxlength="1000">
                            </div>
                        <?php endforeach; ?>
                    </div>
