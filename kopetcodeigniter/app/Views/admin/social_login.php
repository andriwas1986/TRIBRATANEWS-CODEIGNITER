...
<div class="row">
    <div class="col-lg-6 col-md-12">
        <div class="card card-primary">
            <div class="card-header with-border">
                <h3 class="card-title"><?= trans('facebook'); ?></h3>
            </div>
            <form action="<?= base_url('Admin/socialLoginSettingsPost'); ?>" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer" style="padding-left: 0; padding-right: 0;">
                        <button type="submit" name="submit" value="facebook" class="btn btn-primary float-end"><?= trans('save_changes'); ?></button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="col-lg-6 col-md-12">
        <div class="card card-primary">
            <div class="card-header with-border">
                <h3 class="card-title"><?= trans('google'); ?></h3>
            </div>
            <form action="<?= base_url('Admin/socialLoginSettingsPost'); ?>" method="post">
                <?= csrf_field(); ?>
                <div class="card-body">
                    ...
                    <div class="card-footer" style="padding-left: 0; padding-right: 0;">
                        <button type="submit" name="submit" value="google" class="btn btn-primary float-end"><?= trans('save_changes'); ?></button>
                    </div>
                </div>
            </form>
        </div>
...
<div class="row">
    <div class="col-lg-6 col-md-12">
        <div class="card card-primary">
            <div class="card-header with-border">
                <h3 class="card-title"><?= trans('vkontakte'); ?></h3>
            </div>
            <form action="<?= base_url('Admin/socialLoginSettingsPost'); ?>" method="post">
                <?= csrf_field(); ?>
                <div class="card-body">
                    ...
                    <div class="card-footer" style="padding-left: 0; padding-right: 0;">
                        <button type="submit" name="submit" value="vk" class="btn btn-primary float-end"><?= trans('save_changes'); ?></button>
                    </div>
                </div>
            </form>
        </div>
