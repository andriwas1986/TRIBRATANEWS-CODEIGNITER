        ...
        if (!empty($avatarPath)) {
            if (file_exists(FCPATH . $avatarPath)) {
                ...
                if (defined('MEDIA_BASE_URL')) {
                    return rtrim(MEDIA_BASE_URL, '/') . '/' . ltrim($avatarPath, '/');
                }
...
if (!function_exists('isAdminNavActive')) {
    function isAdminNavActive($arrayNavItems, $className = 'active')
    {
    ...
    function getPostImage($post, $imageSize)
    {
        ...
        if (!empty($post->image_data)) {
            ...
            if ($image['storage'] == 'aws_s3') {
                ...
                // --- [MODIFIKASI MULTI-SITE START] ---
                // Gunakan rtrim/ltrim untuk mencegah double slash
                if (defined('MEDIA_BASE_URL')) {
                    $path = rtrim(MEDIA_BASE_URL, '/') . '/' . ltrim($image['path'], '/');
                } else {
