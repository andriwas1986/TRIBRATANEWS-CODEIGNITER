...
class App extends BaseConfig
{
     ...
     */
    public string $baseURL = 'https://waskitho.suaramadiun.com/'; // Default Fallback

    /**
     * --------------------------------------------------------------------------
     * DYNAMIC BASE URL (Multi-Site Logic)
     * --------------------------------------------------------------------------
     * Constructor ini akan mendeteksi domain/subdomain yang sedang diakses
     * dan mengubah baseURL secara otomatis.
     */
    public function __construct()
    {
        parent::__construct();

        // Cek apakah script dijalankan lewat Browser (bukan CLI)
        if (isset($_SERVER['HTTP_HOST'])) {
            // Tentukan protokol (HTTP atau HTTPS)
            $protocol = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on') ? 'https://' : 'http://';
            
            // Set baseURL sesuai dengan domain yang ada di address bar browser
