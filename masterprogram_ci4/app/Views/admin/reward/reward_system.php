...
<div class="row">
    <div class="col-lg-6 col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header with-border">
                <h3 class="card-title"><?= trans('payout_methods'); ?></h3>
            </div>
    ...
    <div class="col-lg-6 col-md-12">
        <div class="card card-primary">
            <div class="card-header with-border">
                <h3 class="card-title"><?= trans('currency'); ?></h3>
            </div>
        ...
        <div class="card card-primary">
            <div class="card-header with-border">
                <h3 class="card-title"><?= trans('human_verification'); ?><br><small><?= trans("human_verification_exp"); ?></small></h3>
            </div>
            <form action="<?= base_url('Reward/updateSettingsPost'); ?>" method="post">
                <?= csrf_field(); ?>
