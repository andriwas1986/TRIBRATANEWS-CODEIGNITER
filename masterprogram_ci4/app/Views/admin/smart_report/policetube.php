<div class="row">
    <div class="col-sm-12">
        <h1 class="page-title">Laporan PoliceTube</h1>
        <ol class="breadcrumb">
            <li><a href="<?= adminUrl(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Laporan PoliceTube</li>
        </ol>
    </div>
</div>

<style>
    /* Styling Tabs - Tema Biru PoliceTube */
    .nav-tabs-custom > .nav-tabs { background-color: #003366; border-bottom-color: #333; }
    ...
    .nav-tabs-custom > .nav-tabs > li > a:hover { color: #ff8d03; }
    ...
    .table-compact-pt thead th:first-child { border-radius: 4px 0 0 4px; }
    .table-compact-pt thead th:last-child { border-radius: 0 4px 4px 0; }
    ...
    /* Kolom NO */
    .table-compact-pt td:first-child { 
        text-align: center; 
        font-weight: bold; 
        color: #003366;
    ...
    /* Kolom LINK */
    .table-compact-pt td:last-child { 
    ...
    .pt-link-text:hover { color: #003366; text-decoration: underline; }
    ...
    .pagination li a { 
        color: #003366; border: 1px solid #ddd; padding: 5px 10px; font-size: 12px; margin-left: 2px; border-radius: 3px; text-decoration: none;
    }
    .pagination li.active a { 
        background-color: #003366; border-color: #003366; color: white; 
    }
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content" style="background: #f4f6f9; padding: 15px;">
                        ...
                        <div class="col-md-6">
                            <form action="<?= current_url(); ?>" method="get" class="form-inline">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date" class="form-control input-sm" value="<?= esc($selectedDate); ?>" onchange="this.form.submit()" style="font-weight:bold; border: 1px solid #003366; color: #003366;">
                                </div>
                            </form>
                        </div>
                        <div class="col-md-6 text-right">
                            <a href="<?= adminUrl('smart-report/policetube/export_excel?date='.$selectedDate); ?>" target="_blank" class="btn btn-success btn-sm btn-flat">
                                ...
                                <tbody>
                                    <?php if(!empty($dailyLinks)): foreach($dailyLinks as $det): ?>
                                        <?php 
                                            ...
                                            $satkerColor = $isPolres ? '#003366' : '#555';
                                            $satkerIcon  = $isPolres ? '<i class="fa fa-shield text-primary"></i> ' : '';
                                            $rowBg = $isPolres ? 'background-color: #f0f5ff;' : ''; 
                                        ?>
                                        <tr style="<?= $rowBg; ?>">
                                            <td><?= $det['no_urut']; ?></td>
                                            ...
                                            <td>
                                                <a href="<?= esc($det['url']); ?>" target="_blank" class="pt-link-text">
                                                    <span class="badge-category-pt">VIDEO</span>
                                                    <?= esc($det['url']); ?>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php endforeach; else: ?>
                                        <tr>
                                            <td colspan="3" class="text-center" style="padding: 20px; color: #999; font-size:12px;">
                                                Belum ada konten PoliceTube untuk tanggal ini.
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                ...
                <div class="tab-pane <?= (isset($_GET['tab']) && $_GET['tab'] == 'range') ? 'active' : ''; ?>" id="tab_range">
                    <form action="<?= current_url(); ?>" method="get" class="well form-inline" style="background: #fff; border-top: 3px solid #003366; padding:10px;">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm m-l-10" style="background-color: #003366;"><i class="fa fa-search"></i> Tampilkan</button>
                        
                        <a href="<?= adminUrl('smart-report/policetube/export_excel?start_date='.$startDate.'&end_date='.$endDate); ?>" target="_blank" class="btn btn-success btn-sm m-l-5">
                            <i class="fa fa-file-excel-o"></i> Download Excel
                        </a>
                    </form>
                                ...
                                <table class="table table-bordered table-striped table-condensed">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="label label-primary btn-xs">Video</span></td>
