<div class="box">
    <div class="box-header with-border">
        ...
        <?php if (isSuperAdmin()): ?>
            <div class="right">
                <a href="<?= adminUrl('export-users'); ?>" class="btn btn-info btn-add-new" style="margin-right: 5px;">
                    <i class="fa fa-download"></i> Export CSV
                </a>
                <button type="button" class="btn btn-warning btn-add-new" data-toggle="modal" data-target="#modalImportUser" style="margin-right: 5px;">
...
<div id="modalImportUser" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= adminUrl('import-users'); ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Import Users (Format Excel / CSV)</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <small class="text-muted" style="display:block; margin-top:10px;">
                            <b>Tips:</b> Klik <i>Export CSV</i> dulu untuk mendapat template kolom. <br>
                            - Jika menambah user baru dan kolom password dikosongkan, password defaultnya otomatis menjadi: <b>123456</b>
                        </small>
                    </div>
                </div>
                <div class="modal-footer">
