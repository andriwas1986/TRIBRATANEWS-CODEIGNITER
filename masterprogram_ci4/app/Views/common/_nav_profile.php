...
<?php endif; ?>
<li><a href="<?= generateProfileURL(user()->slug); ?>" class="dropdown-item">
<div class="icon">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" color="#747474" fill="none">
...
<li>
<a href="<?= adminUrl('author-earnings'); ?>" class="dropdown-item">
<div class="icon">
<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
...
</div><?= trans("earnings"); ?>&nbsp;(<strong><?= priceFormatted(user()->balance); ?></strong>)
</a>
</li>
<?php endif; ?>
<li>
<a href="<?= generateURL('reading_list'); ?>" class="dropdown-item">
<div class="icon">
<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#747474" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-star">
...
<li>
<a href="<?= generateURL('settings'); ?>" class="dropdown-item">
<div class="icon">
<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#747474" viewBox="0 0 256 256">
<path
