        ...
        <div class="row footer-widgets">
            <div class="col-sm-4 col-xs-12">
                <div class="footer-widget f-widget-about">
                    <div class="col-sm-12">
                        <div class="row">
                            <p class="footer-logo"><img src="<?= getLogoFooter(); ?>" alt="logo" class="logo" width="<?= getLogoSize('width'); ?>" height="<?= getLogoSize('height'); ?>"></p>
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="footer-widget f-widget-random">
                    <div class="col-sm-12">
                        <div class="row">
                            <h4 class="title"><?= trans("trending_posts"); ?></h4>
...
<script src="<?= base_url($assetsPath. '/js/jquery-migrate-3.6.0.min.js'); ?>"></script>

<script src="<?= base_url($assetsPath. '/js/plugins-2.4.3.js'); ?>"></script>
