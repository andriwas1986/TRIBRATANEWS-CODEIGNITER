...
<link rel="stylesheet" href="<?= base_url('assets/css/jnews_themes.css'); ?>">
<?= $generalSettings->custom_header_codes; ?>
</head>
<body class="<?= $activeTheme->theme; ?> theme-jnews-lifestyle <?= $darkMode == true ? 'dark-mode' : ''; ?> <?= $activeLang->text_direction == 'rtl' ? 'rtl-mode' : ''; ?>">
